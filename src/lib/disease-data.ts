...
function treatmentList(name: string): string[] {
  const map: Record<string, string[]> = {
    "Atopic Dermatitis": ["Medical Management", "Moisturising Therapy", "Topical Steroids", "Antihistamines"],
    "Back Acne": ["Topical Medications", "Oral Antibiotics", "Chemical Peels", "Laser Therapy"],
    "Seborrheic Keratosis": ["Dermatological Evaluation", "Cryotherapy", "Electrocautery", "Surgical Removal"],
    Eczema: ["Medical Management", "Topical Steroids", "Moisturising Therapy", "Phototherapy"],
    Hyperpigmentation: ["Topical Lightening Agents", "Chemical Peels", "Laser Therapy", "Medical Management"],
    ...
    "Stevens-Johnson Syndrome": ["Immediate Hospitalisation", "Specialised Wound Care", "Medical Management"],
...
export const skinDiseases: Disease[] = [
  {
    ...
    description: "Atopic Dermatitis, commonly called eczema, is a chronic skin condition that causes dry, itchy, red, and inflamed skin. It often affects children but can occur at any age. Proper treatment helps control flare-ups, relieve itching, and restore healthy skin.",
    symptoms: ["Severe itching", "Dry and rough skin", "Red inflamed patches", "Skin cracking", "Thickened skin after repeated scratching"],
    category: "skin",
  ...
  },
  {
    ...
    description: "Back acne develops when hair follicles become clogged with oil, bacteria, and dead skin cells. Without treatment it may leave permanent scars. Early medical care helps prevent future breakouts and improves skin appearance.",
  ...
  },
  {
    ...
    description: "Seborrheic Keratosis is a common, non-cancerous skin growth that usually appears with age. Although harmless, it may resemble skin cancer. A dermatologist can accurately diagnose and safely remove it if necessary.",
    symptoms: ["Brown or black growths", "Waxy appearance", "Rough texture", "Raised lesions", "Mild itching"],
    category: "skin",
  ...
  },
  {
    ...
    description: "Eczema is a skin condition that causes inflammation, dryness, redness, and intense itching. Triggers may include allergies, weather changes, soaps, or stress. Medical treatment helps reduce symptoms and prevents repeated flare-ups.",
  ...
  },
  {
    ...
    description: "Hyperpigmentation causes dark patches due to excess melanin production. It can result from sun exposure, acne marks, hormonal changes, or skin injuries. Modern treatments help reduce pigmentation and improve skin tone.",
  ...
  },
  {
    ...
    description: "Nail psoriasis affects the fingernails or toenails, causing pitting, discoloration, thickening, and nail separation. Early treatment helps improve nail appearance and prevent permanent damage.",
  ...
  },
  {
    ...
    description: "Psoriasis is a chronic autoimmune condition that causes thick, red, scaly skin patches. Although it cannot always be permanently cured, modern treatments effectively control symptoms, reduce flare-ups, and improve quality of life.",
  ...
  },
  {
    ...
    description: "Stevens-Johnson Syndrome is a rare but serious skin reaction, often triggered by medications or infections. It requires immediate medical attention. Early diagnosis and specialized treatment are essential for recovery.",
  ...
  },
  {
    ...
    description: "Vitiligo is a condition where skin loses its natural pigment, leading to white patches. Although not contagious, it can affect confidence. Modern dermatology treatments help restore pigmentation and slow disease progression.",
    symptoms: ["White patches", "Hair whitening", "Symmetrical pigment loss", "Gradual spread", "Sensitive skin"],
    category: "skin",
  ...
  },
  {
    ...
    description: "Warts and Molluscum Contagiosum are viral skin infections that produce small bumps on the skin. While some disappear naturally, professional treatment provides faster clearance and reduces the risk of spreading.",
    symptoms: ["Small raised bumps", "Rough surface", "Skin-colored growths", "Mild discomfort", "Spread to nearby skin"],
    category: "skin",
